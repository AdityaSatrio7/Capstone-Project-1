...
<html lang="en">
  <head>
    ...
    <link href="{{ asset('icomoon/icomoon.css') }}" rel="stylesheet">
          ...
          <div class="container">
            <div class="row d-flex align-items-center">
              <div class="col-md-4 header-contact">
                <p>Aditya Imam Satrio <strong>+62 8953 4385 9988</strong>
                </p>
              </div>
              <div class="col-md-4 shipping-purchase text-center">
                <p>Galeri Pakaian dan Wedding Organizer</p>
              </div>
                ...
                <div class="navbar">
                  ...
                  <div id="main-nav" class="stellarnav d-flex justify-content-end right">
                    <ul class="menu-list">
                      ...
                      <li><a href="about.html" class="item-anchor" data-effect="About">Tentang kami</a></li>

                      <li class="menu-item has-sub">
                        <a href="shop.html" class="item-anchor d-flex align-item-center" data-effect="Shop">Shop<i class="icon icon-chevron-down"></i></a>
                        <ul class="submenu">
                          <li><a href="shop.html" class="item-anchor">Belanja</a></li>
                          ...
                          <li><a href="cart.html" class="item-anchor">Keranjang<span class="text-primary"> (PRO)</span></a></li>
          ...
          <div class="row d-flex flex-wrap justify-content-between">
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="footer-menu">
                <h5 class="widget-title">Nandhita</h5>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="footer-menu">
                ...
                <p>Punya saran untuk kami? <a href="#" class="email">nandhitagallery@gmail.com</a>
                </p>
                <p>Butuh bantuan? <br>
                  <strong>+62 8953 4385 9988</strong>
                </p>
              </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6">
